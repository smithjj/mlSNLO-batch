...
| mix_2d_lp_save_movie | scalar | (logical) | Save movie data to file. The file can be large and can take a while to save to disk. |
| mix_2d_lp_auto_analyze | scalar | (logical) | Automatically analyze beam for each wave after model finishes (beam quality, tilt, radius of curvature). This can be slow. |
...
| mix_2d_sp_crystal_losses | 3 element vector | 1/mm |  crystal loss | 
| mix_2d_sp_n2_red1 | 3 element vector |  cm^2/W | n2 (red1) | 
| mix_2d_sp_n2_red2 | 3 element vector |  cm^2/W | n2 (red2) | 
| mix_2d_sp_n2_blue | 3 element vector |  cm^2/W | n2 (blue) | 
| mix_2d_sp_beta_red1 | 3 element vector | cm/W | beta (red1) | 
| mix_2d_sp_beta_red2 | 3 element vector | cm/W | beta (red2) | 
| mix_2d_sp_beta_blue | 3 element vector | cm/W | beta (blue) |
...
| mix_2d_sp_lx_ly | 2 element vector | mm | Crystal width and height. | 
...
| Fieldname | Type | Units | Description |
| - | - | - | - |
|  opg_2d_wavelengths      | 3 element vector | nm | wavelengths in nm; for red1, red2, and blue waves | 
...
|  opg_2d_gdd              | 3 element vector | fs^2/mm | group delay dispersions for red1, red2, and blue waves | 
|  opg_2d_phase            | 3 element vector | rad | input phase of waves red1, red2, blue | 
...
|  opg_2d_crystal_losses   | 3 element vector | 1/mm | linear absorption for red1, red2, and blue waves | 
|  opg_2d_n2_red1          | 3 element vector | cm^2/W | for red1, nonlinear refractive index for red1, red2, and blue waves | 
|  opg_2d_n2_red2          | 3 element vector | cm^2/W | for red2, nonlinear refractive index for red1, red2, and blue waves | 
|  opg_2d_n2_blue          | 3 element vector | cm^2/W | for blue, nonlinear refractive index in sq cm/W; for red1, red2, and blue waves | 
|  opg_2d_beta_red1        | 3 element vector | cm/W | for red1, two-photon absorption in cm/W; for red1, red2, and blue waves | 
|  opg_2d_beta_red2        | 3 element vector | cm/W | for red2, two-photon absorption in cm/W; for red1, red2, and blue waves | 
|  opg_2d_beta_blue        | 3 element vector | cm/W | for blue, two-photon absorption in cm/W; for red1, red2, and blue waves | 
|  opg_2d_pulseenergy      | 3 element vector | J or W| input pulse energy or power (if cw) ; for red1, red2, and blue waves | 
|  opg_2d_pulse_durations  | 3 element vector | fwhm ps | Input pulse full-width half-max durations; for red1, red2, and blue waves; optionally array of 3x2 where 2nd dimension is integer 0-10 for sech^2 or (super) gaussian shape.| 
|  opg_2d_pulse_delays     | 3 element vector | ps | Input pulse delays relative to blue pulse center; vector of 3 elements (for red1, red2, and blue) but the value of the 3rd element is not used. | 
|  opg_2d_pulse_chirps     | 3x1, 3x2, or 3x3 array | THz/ps or THz/ps^2 or THz/ps^3 | Chirp of input pulse. 3 element array for linear chirp only (for red1, red2, and blue waves). Optionally can use higher order chirp, growing the array to be 3x2 or 3x3 for quadratic or cubic chirps. | 
|  opg_2d_beam_diameters   | 3x1 or 3x2 array | FWHM | Diameters of input beam fwhm; for red1, red2, and blue waves. Array of size 3x1 will be circular beam, sized 3x2 will be elliptical (the first row is diameter in x, the direction of birefringent walkoff, and the second perpendicular to that). | 
|  opg_2d_supergaussian_coeff | 3 element vector | | Spatial super gaussian coefficient, positive values. Values of 1 are Gaussian in shape, larger values are more flat-topped. For red1, red2, and blue waves. | 
|  opg_2d_wo_angles        | 3 element vector |  mrad | Birefringent walk off angle; for red1, red2, and blue waves. | 
|  opg_2d_offset_wodir     | 3 element vector |  mm | Input beam displacement in the direction of birefringent walkoff relative to center of grid; for red1, red2, and blue waves. | 
